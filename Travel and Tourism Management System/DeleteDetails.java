...
//Image:
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ic\\icons\\viewall.jpg")); //to load an image from the specified path to be displayed on the view customer screen
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("ic\\icons\\viewall.jpg")); //to load an image from the specified path to be displayed on the view customer screen
