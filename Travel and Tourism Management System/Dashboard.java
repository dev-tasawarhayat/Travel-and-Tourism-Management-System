...
//Image:
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ic\\icons\\dashboard.png")); //to load the dashboard image from the resources folder
        Image i2 = i1.getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT); //to scale the image to fit the dashboard
        ImageIcon i3 = new ImageIcon(i2); //to create a new ImageIcon from the scaled image
        JLabel icon = new JLabel(i3); //to create a JLabel to hold the image
        icon.setBounds(5, 0, 70, 70); //to set the position and size of the image on the dashboard
        p1.add(icon); //to add the image to the dashboard
...
//Image:
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("ic\\icons\\home.jpg")); //to load the home image from the resources folder
