...
//Image:
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ic\\icons\\bookedDetails.jpg")); //to load an image from the specified path to be displayed on the view customer screen
